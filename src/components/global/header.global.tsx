...
const Header = ({ header }: HeaderProps) => {
  ...
  return (
    <header className="sticky top-0 z-50 flex justify-center px-4 pt-4">
      <nav className="container relative w-full flex items-center justify-between gap-1 rounded-full border border-gray-900 bg-secondary/80 px-2 py-2 backdrop-blur-md">
